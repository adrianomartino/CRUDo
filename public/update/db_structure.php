<?php
  ...
  require_once('../../application/bootstrap.php');
    ...
    //load db structure in DB object
    $DbStructure=EasyQuery::getDbStructure();
    
    //check if the DB is compatible with the sistem
    //new DbCheck(); //only for production //doens't work
    
    $myFile = '../../application/config/_DbStructure.php';
    $fh = fopen($myFile, 'w') or die("can't open file");
  


    fwrite($fh, "<?php\n");    
    set_array_to_file($fh,$DbStructure);
    fwrite($fh, '?>');  
    fclose($fh);
    
    echo 'If you don\'t see errors the database infos have been indicized';
    ...
    /**
     *
     *Copied from http://www.roscripts.com/snippets/show/198
     *
 ...
 */
function set_array_to_file($file,$array,$string="\$DbStructure") {
